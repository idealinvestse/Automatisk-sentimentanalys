...
- `tests/` — 716+ tests. Run with `pytest`. Full when-to-run-what runbook: [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) § Testing (L0–L9). Release path: [docs/PRODUCTION_CHECKLIST.md](docs/PRODUCTION_CHECKLIST.md) § Release verification.
