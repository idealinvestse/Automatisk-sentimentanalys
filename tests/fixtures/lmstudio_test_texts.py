...
FAKTURA_TVIST: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Ja, jag har fått en faktura som är helt fel. Ni har debiterat mig dubbelt.",
        1,
    ),
    _seg("SPEAKER_00", "Okej, låt mig kolla upp det här. Kan du ge mig ditt fakturanummer?", 2),
    _seg(
        "SPEAKER_01",
        "Det är 47291. Jag har redan ringt två gånger om det här och ingen har löst det.",
        3,
    ),
    _seg(
        "SPEAKER_00",
        "Jag förstår. Jag ska titta på det. Det verkar som att det är en teknisk fel.",
        4,
    ),
    _seg(
        "SPEAKER_01",
        "En teknisk fel? Jag har betalat för mycket i två månader nu. Det är inte okej.",
        5,
    ),
    _seg(
        "SPEAKER_00",
        "Ja, jag förstår att det är så här det fungerar ibland. Jag kan kreditnota dig.",
        6,
    ),
    _seg(
        "SPEAKER_01", "Så här det fungerar? Jag vill ha pengarna tillbaka, inte en kreditnota!", 7
    ),
    ...
    _seg(
        "SPEAKER_00",
        "Jag förstår att det är frustrerande, men det är vad jag kan göra just nu.",
        12,
    ),
...
TEKNIK_SUPPORT: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Ja, mitt internet har varit instabilt i tre dagar nu. Det fungerar och sen fungerar det inte.",
        1,
    ),
    _seg(
        "SPEAKER_00",
        "Jag förstår att det är frustrerande. Låt oss felsöka. Är din router inkopplad?",
        2,
    ),
    _seg("SPEAKER_01", "Ja, allt är inkopplad som det ska. Jag har startat om den tre gånger.", 3),
    _seg(
        "SPEAKER_00", "Okej, bra. Kan du berätta vilken ljusindikator du ser på routern just nu?", 4
    ),
    _seg("SPEAKER_01", "Det lyser rött där det ska vara grönt. Internet-lampan alltså.", 5),
    _seg(
        "SPEAKER_00",
        "Rött på internet-lampan tyder på att vi har ett problem på vår sida. Jag ska undersöka.",
        6,
    ),
    _seg("SPEAKER_01", "Äntligen någon som lyssnar. Jag har försökt få hjälp i flera dagar.", 7),
    _seg(
        "SPEAKER_00",
        "Jag hör dig. Det låter som att det kan finnas en störning i ditt område. Låt mig kolla.",
        8,
    ),
    _seg("SPEAKER_01", "Okej, väntar.", 9),
    _seg(
        "SPEAKER_00",
        "Ja, jag kan se att det finns en kabelbrott på din adress. Vi har en tekniker på väg.",
        10,
    ),
    _seg("SPEAKER_01", "Bra! När tror ni att det är löst?", 11),
    _seg(
        "SPEAKER_00",
        "Vi räknar med att det är åtgärdat inom 24 timmar. Jag lägger en notering på ditt konto.",
        12,
    ),
...
UPPSAGNINGSHOT: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "För att er service är usel. Jag har haft problem i månader och ingen tar ansvar.",
        3,
    ),
    _seg("SPEAKER_00", "Jag förstår att du är missnöjd. Låt mig se vad jag kan göra för dig.", 4),
    _seg(
        "SPEAKER_01",
        "Vad du kan göra? Ni har logat mig att ringa tillbaka tre gånger och det har ni inte gjort.",
        5,
    ),
    _seg(
        "SPEAKER_00",
        "Det låter inte alls bra. Jag ber om ursäkt för det. Låt mig titta på din historik.",
        6,
    ),
    _seg("SPEAKER_01", "Ursäkter hjälper inte. Jag vill ha en lösning eller så är jag borta.", 7),
    _seg(
        "SPEAKER_00", "Jag hör dig. Jag kan erbjuda dig en rabatt på tre månader om du stannar.", 8
    ),
    _seg(
        "SPEAKER_01",
        "En rabatt? Tror du att det löser grundproblemet? Problemet är att ni inte levererar.",
        9,
    ),
    _seg(
        "SPEAKER_00",
        "Du har rätt. Låt mig eskalera det här till vår kundklubb som kan hantera det ordentligt.",
        10,
    ),
    _seg(
        "SPEAKER_01", "Äntligen. Men om inte den här gången fungerar så är det definitivt slut.", 11
    ),
    _seg(
        "SPEAKER_00",
        "Jag förstår. Jag lägger en prioriterad ärendehantering och de hör av sig inom 24 timmar.",
        12,
    ),
    _seg("SPEAKER_01", "Okej. Det är er sista chans.", 13),
    _seg(
        "SPEAKER_00",
        "Jag uppskattar att du ger oss den chansen. Jag noterar det i ärendet. Ha en bra dag.",
        14,
    ),
...
SARKASM: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Ja, jag har väntat i 45 minuter i kö, men det är väl så det fungerar hos er.",
        1,
    ),
    _seg("SPEAKER_00", "Jag ber om ursäkt för väntetiden. Vad gäller det?", 2),
    _seg(
        "SPEAKER_01",
        "Jo, jag har ju betalat för en tjänst som inte fungerar. Men det är väl normalt att man betalar för saker som inte fungerar?",
        3,
    ),
    _seg("SPEAKER_00", "Jag förstår att du är frustrerad. Kan du berätta mer om problemet?", 4),
    _seg(
        "SPEAKER_01",
        "Åh, jag får gärna berätta mer. Det är ju inte som om jag har gjort det tre gånger redan.",
        5,
    ),
    _seg("SPEAKER_00", "Jag ska verkligen titta på det här nu. Vad är det specifika problemet?", 6),
    _seg(
        "SPEAKER_01",
        "Det specifika problemet? Tja, internet fungerar inte. Men det är väl för mycket begärt att det ska fungera när man betalar för det?",
        7,
    ),
    _seg("SPEAKER_00", "Jag förstår. Låt mig felsöka. Är routern inkopplad?", 8),
    _seg(
        "SPEAKER_01",
        "Självklart är den inkopplad. Tror ni att jag ringer för att jag inte vet hur man kopplar in en router?",
        9,
    ),
    _seg(
        "SPEAKER_00", "Jag ber om ursäkt, jag måste fråga för att utesluta grundläggande fel.", 10
    ),
    _seg(
        "SPEAKER_01",
        "Självklart, det är ju inte som om jag kan förvänta mig att ni har koll på mitt ärende redan.",
        11,
    ),
    _seg(
        "SPEAKER_00", "Jag kan se att det finns en störning i ditt område. Vi arbetar på det.", 12
    ),
    _seg(
        "SPEAKER_01",
        "Åh, ni arbetar på det? Vilken lyx. Då kan jag ju slappna av och vänta i evighet.",
        13,
    ),
    _seg("SPEAKER_00", "Vi räknar med att det är löst inom 24 timmar.", 14),
    _seg(
        "SPEAKER_01",
        "24 timmar? Självklart. Det är ju inte som om jag behöver internet för att jobba eller något.",
        15,
    ),
]
...
TYSTNAD: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_00",
        "Jag hör att det har varit frustrerande. Låt oss titta på det tillsammans.",
        14,
    ),
...
MULTI_ISSUE: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Jag har flera problem. Först är min faktura fel, sen fungerar inte internet, och jag vill också byta paket.",
        1,
    ),
    ...
    _seg(
        "SPEAKER_01",
        "Jag har aldrig beställt premium-support. Och det leder mig till internet-problemet.",
        7,
    ),
    ...
    _seg(
        "SPEAKER_01",
        "Då förstår du varför jag vill byta paket också. Jag betalar för mycket och får inget.",
        11,
    ),
    _seg("SPEAKER_00", "Låt mig titta på alltihop. Det kan ta en stund.", 12),
    _seg(
        "SPEAKER_01",
        "Så jag ska vänta igen? Medan jag betalar för saker jag inte har beställt?",
        13,
    ),
...
FORVIRRAD_KUND: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Hej... jag vet inte riktigt. Jag fick ett brev från er, men jag förstår inte vad det betyder.",
        1,
    ),
    _seg("SPEAKER_00", "Inga problem. Kan du berätta vad det står i brevet?", 2),
    _seg(
        "SPEAKER_01",
        "Det står något om faktura, men jag betalar ju via autogiro. Varför får jag brev?",
        3,
    ),
    _seg(
        "SPEAKER_00",
        "Det kan vara en påminnelse eller en specifik faktura. Låt mig kolla ditt konto.",
        4,
    ),
    ...
    _seg(
        "SPEAKER_00",
        "Det kan bero på ett tekniskt fel. Vi kan åtgärda det. Vill du att jag hjälper dig med det?",
        8,
    ),
    _seg(
        "SPEAKER_01",
        "Ja, men jag förstår inte hur det här kan hända. Jag har haft autogiro i flera år.",
        9,
    ),
    _seg(
        "SPEAKER_00",
        "Jag förstår att det är förvirrande. Låt mig förklara vad som hände och hur vi fixar det.",
        10,
    ),
    _seg("SPEAKER_01", "Vänligen, ta det lugnt. Jag är inte så bra på datorer och sånt här.", 11),
    _seg(
        "SPEAKER_00",
        "Ingen fara. Jag går steg för steg. Först ska jag kontrollera att dina bankuppgifter stämmer.",
        12,
    ),
    _seg("SPEAKER_01", "Okej. Men betalar jag extra för det här?", 13),
    _seg(
        "SPEAKER_00",
        "Nej, du betalar inte extra. Det är ett fel från vår sida och vi åtgärdar det gratis.",
        14,
    ),
    _seg(
        "SPEAKER_01",
        "Åh, tack. Då känner jag mig lugnare. Kan du hjälpa mig att säkerställa att det inte händer igen?",
        15,
    ),
]
...
EMPATISKT_SAMTAL: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_00",
        "Jag förstår att det kan vara oroande. Låt oss titta på det tillsammans så löser vi det.",
        2,
    ),
    _seg(
        "SPEAKER_01",
        "Tack, det känns bra att höra. Fakturan visar 1200 kronor men det brukar vara 600.",
        3,
    ),
    _seg(
        "SPEAKER_00",
        "Okej, låt mig kolla. Jag kan se att det har lagts till en extra tjänst i mars. Vet du om du beställt något?",
        4,
    ),
    _seg(
        "SPEAKER_01", "Nej, jag har inte beställt något extra. Men min son kanske har gjort det?", 5
    ),
    _seg(
        "SPEAKER_00",
        "Det är möjligt. Jag kan se att beställningen kom från din enhet. Men oroa dig inte, vi kan kreditera beloppet och avsluta tjänsten.",
        6,
    ),
    _seg("SPEAKER_01", "Åh, vad snällt. Det låter jättebra.", 7),
    _seg(
        "SPEAKER_00",
        "Jag lägger en kredit på 600 kronor och avslutar extra-tjänsten. Det blir fixat inom 24 timmar.",
        8,
    ),
    _seg("SPEAKER_01", "Tack så mycket! Det känns verkligen bra att få så bra hjälp.", 9),
    _seg(
        "SPEAKER_00",
        "Varsågod. Jag vill också hjälpa dig att sätta ett lösenordsskydd så att det inte händer igen.",
        10,
    ),
    _seg("SPEAKER_01", "Ja, det vore jättebra. Hur gör vi det?", 11),
    _seg(
        "SPEAKER_00",
        "Jag skickar en länk till din e-post där du kan sätta en PIN-kod för framtida beställningar.",
        12,
    ),
...
KORT_ARGT: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01", "Vad som hänt? Allt har hänt! Ingenting fungerar och ni gör inget åt det!", 3
    ),
    ...
    _seg(
        "SPEAKER_00",
        "Jag förstår ditt beslut. Men innan du går, kan jag erbjuda dig en lösning?",
        8,
    ),
...
ATERKOMMANDE_KUND: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Ja, det här är femte gången jag ringer om samma problem. Jag är trött på det här.",
        1,
    ),
    _seg(
        "SPEAKER_00",
        "Jag ber om ursäkt för att du har behövt ringa flera gånger. Vad är det som gäller?",
        2,
    ),
    _seg(
        "SPEAKER_01",
        "Mitt internet fungerar inte. Det har varit så i tre veckor nu. Varje gång jag ringer får jag löften om att det ska fixas.",
        3,
    ),
    _seg("SPEAKER_00", "Jag förstår att det är frustrerande. Låt mig titta på din historik.", 4),
    _seg(
        "SPEAKER_01",
        "Min historik? Den visar väl att inget har gjorts. Fem samtal och inget resultat.",
        5,
    ),
    _seg(
        "SPEAKER_00",
        "Jag kan se att det finns flera ärenden. Jag ska se till att det här prioriteras.",
        6,
    ),
    _seg("SPEAKER_01", "Prioriteras? Det har ni sagt varje gång. Jag har hört det förut.", 7),
    _seg(
        "SPEAKER_00",
        "Jag förstår din skepsis. Den är berättigad. Men jag ska personligen följa upp det här ärendet.",
        8,
    ),
    _seg("SPEAKER_01", "Personligen? Vad betyder det i praktiken? Att du ringer mig tillbaka?", 9),
    _seg(
        "SPEAKER_00",
        "Ja, jag lovar att jag ringer dig tillbaka inom 24 timmar med en konkret lösning.",
        10,
    ),
    _seg("SPEAKER_01", "Okej. Men om inte det här fungerar så är det slut. Jag menar allvar.", 11),
    _seg(
        "SPEAKER_00",
        "Jag tar det på stort allvar. Jag noterar ditt nummer och ärendet som prioriterat.",
        12,
    ),
    _seg(
        "SPEAKER_01",
        "Bra. Då väntar jag på ditt samtal. Men jag hoppas du förstår att mitt tålamod är slut.",
        13,
    ),
    _seg(
        "SPEAKER_00",
        "Jag förstår. Jag uppskattar att du ger oss en sista chans. Vi hörs imorgon.",
        14,
    ),
...
CODE_SWITCHING: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Hej, jag har problem med min router. Den har ingen internet connection alls.",
        1,
    ),
    _seg(
        "SPEAKER_00",
        "Okej, låt oss felsöka. Kan du se om det är en röd eller grön LED på routern?",
        2,
    ),
    _seg("SPEAKER_01", "Det är rött. Jag har försökt reset flera gånger men det hjälper inte.", 3),
    _seg(
        "SPEAKER_00", "Har du kollat om det är ett problem med din ISP eller med själva routern?", 4
    ),
    ...
    _seg(
        "SPEAKER_00", "Det är möjligt. Men jag kan se att det finns en kabelbrott i ditt område.", 8
    ),
    ...
    _seg(
        "SPEAKER_00",
        "Ja, det är alltid bra att hålla firmware uppdaterat. Jag skickar en guide.",
        12,
    ),
...
ENDAST_AGENT: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_00",
        "Okej, det verkar som att vi tappade kontakten. Jag lägger på och du får ringa igen.",
        3,
    ),
]
...
ENDAST_KUND: list[dict[str, Any]] = [
    ...
    _seg(
        "SPEAKER_01",
        "Okej, ingen svarar. Jag ville bara säga att fakturan visar 1500 men det ska vara 800.",
        2,
    ),
