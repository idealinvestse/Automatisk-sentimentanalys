...
- **Produktionschecklista verifierad (D.3)** — `docs/PRODUCTION_CHECKLIST.md` uppdaterad med verifierade statusar (15 PASS, 4 FAIL, 1 PARTIAL) och fil:line-referenser för varje item. Ny `.env.example` med alla 25+ env vars. Ny `docs/examples/prometheus.yml` scrape-config-exempel. Backup-guide dokumenterad. Kvarstående gaps: PII-default, GPU-verifiering, automatiserad backup.
