...
from app.archive.nicegui_dashboard.services.transcription_result_helpers import (
    segments_table_rows,
...
from app.archive.nicegui_dashboard.services.transcription_runtime import MAX_AUDIO_BYTES
