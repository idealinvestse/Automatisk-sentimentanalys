...
from app.archive.nicegui_dashboard.components.alerts_panel import count_active_alerts
from app.archive.nicegui_dashboard.components.theme import apply_dashboard_theme
