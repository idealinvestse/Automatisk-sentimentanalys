...
from app.archive.nicegui_dashboard.components.ui_primitives import metric_card
from app.archive.nicegui_dashboard.services.analytics_summary import compute_portfolio_kpis
